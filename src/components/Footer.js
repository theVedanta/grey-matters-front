      ...
      <div className="footer footer-container">
        <div className="footer footer-wrap">
            <div className="footer-text">
              <p className="footer header">Powered by <span className="cw">Code Warriors</span></p>  
            ...
            <div className="footer big socials-wrap">
              <div className="footer big socials">
                ...
                <a href="https://www.instagram.com/codewarriors42/?hl=en"><FaInstagram style={Iconstyle}/></a>
                <a href="https://github.com/codewarriors42"><FaGithub style={Iconstyle}/></a>
                <a href="https://www.behance.net/codewarriors"><FaBehance className="reactIcons" style={Iconstyle}/></a>
              </div>
            </div>  
        </div>
      </div>
